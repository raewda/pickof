...
@Composable
fun Nine(navController: NavHostController, resultnine: MutableState<Boolean>){
    ...
    Scaffold(
        ...
        Card(
            ...
            Column(
                ...
                fun rand() : gameButton {
                    return gameButton.getById(Random.nextInt(1, 18))
                }
